...
<div class="container">
    ...
    <form method="POST">
        ...
        <select name="contribution_at">
            <option value="begin" <?= (($_POST['contribution_at'] ?? '') == 'begin') ? 'selected' : '' ?>>Beginning</option>
        ...
        <input type="number" name="investment_year" placeholder="Years" value="<?= $_POST['investment_year'] ?? '' ?>" required />
        <input type="number" name="investment_month" placeholder="Months" value="<?= $_POST['investment_month'] ?? '' ?>" required />
